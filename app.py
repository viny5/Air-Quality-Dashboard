            ...
            with st.spinner("Generating forecast..."):
                ...
                if pol.lower() not in df.columns:  # Match data column in lowercase
                    ...
                    try:
                        ...
                        # --- Save the forecast in session state for Model Evaluation Tab ---
                        st.session_state["latest_forecast_input"] = valid_subset
                        st.session_state["latest_forecast_output"] = forecasted_values
                        st.session_state["latest_forecast_model"] = model
